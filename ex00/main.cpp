...
int main()
{
  ...
  // std::cout << "test4's type: " << test4->getType() << " " << std::endl;
  // std::cout << "\n\n" << std::endl;
  // std::cout << "testing Dog's copy assignment constructor" << std::endl;
  // Dog* test6 = new Dog();
  // Dog* test7 = new Dog();
  // std::cout << "test6's type: " << test6->getType() << " " << std::endl;
  // std::cout << "test7's type: " << test7->getType() << " " << std::endl;
  // *test7 = *test6;
  // test7->setType("HAHA");
  // std::cout << "test6's type: " << test6->getType() << " " << std::endl;
  // std::cout << "test7's type: " << test7->getType() << " " << std::endl;
  // std::cout << "\n\n" << std::endl;
  // std::cout << "testing Dog's copy constructor" << std::endl;
  // Dog* test8 = new Dog(*test7);
  // std::cout << "test5's type: " << test8->getType() << " " << std::endl;
  // test8->setType("lmaoo");
  // std::cout << "test8's type: " << test8->getType() << " " << std::endl;
  // std::cout << "test7's type: " << test7->getType() << " " << std::endl;
  // std::cout << "\n\n" << std::endl;
